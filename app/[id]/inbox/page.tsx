...
import RenderModal from "@/app/components/modal/RenderModal";
...
function InboxListHeader() {
  return (
    <div className="grid grid-cols-4 py-[16px] px-[20px] w-full justify-between">
      <div>Inbox name</div>
...
function NoInbox() {
  return (
    <div className="max-w-[300px] mx-auto flex flex-col gap-4 justify-center items-center text-center">
      <svg
        width="200"
        height="200"
        viewBox="0 0 200 200"
